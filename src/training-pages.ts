...
export const trainingPages: TrainingPage[] = [
  {slug:'pilates',title:'Пилатес',icon:'pilates.webp',hero:'pilates.webp',keywords:['пилатес','pilates'],description:'Контролирано движение, стабилност и повече лекота във всяко движение.'},
  {slug:'body-balance',title:'Body Balance',icon:'body-balance.webp',hero:'body-balance.webp',keywords:['body balance','баланс'],description:'Хармонична тренировка за баланс, мобилност и спокойна сила.'},
  {slug:'body-training',title:'Body Training',icon:'body-training.webp',hero:'body-training.webp',keywords:['body training'],description:'Цялостна тренировка за сила, тонус и увереност.'},
  {slug:'zumba',title:'Зумба',icon:'zumba.webp',hero:'zumba.webp',keywords:['зумба','zumba'],description:'Динамично движение, музика и много положителна енергия.'},
  {slug:'kids-conditioning',title:'Детска кондиционна',icon:'kids-conditioning.webp',hero:'kids-conditioning.webp',keywords:['детска','кондиционен тим'],description:'Забавна и полезна тренировка за активни и уверени деца.'},
