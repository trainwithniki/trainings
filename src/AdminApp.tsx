...
function LoginPanel(){
  ...
  const [mode,setMode]=useState<'login'|'activate'>(invitationParams.get('activate')==='1'?'activate':'login');const [error,setError]=useState('');const [message,setMessage]=useState('');const [busy,setBusy]=useState(false);const [showPassword,setShowPassword]=useState(false);
